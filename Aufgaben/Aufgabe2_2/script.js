...
(function (Aufgabe2_2) {
    ...
    */
    ...
    let s1 = new Student("Leinert", "Immanuel", 19, 266573, 2);
    let s2 = new Student("Koch", "Günter", 21, 265625, 2);
    let s3 = new Student("Richter", "Paul", 20, 262581, 2);
    ...
    //Aufgabe_2a
    function backwards(_backArray) {
        let resultArray = [];
        for (let i = _backArray.length - 1; i >= 0; i--) {
    ...
    //Aufgabe_2c
    function split(_splitArray, _indexNumber1, _indexNumber2) {
        let resultArray = [];
    ...
    let blueGardient = context.createLinearGradient(50, 200, 400, 500);
